...
** Some data elements are spread across multiple rows to account for the different ways they may be mapped to a standardized terminology. Where this occurs, the rows will be blank except for the terminology codes.
  ...
  { row: 18, column: 2, text: "Standard Overlay" },
  { row: 18, column: 3, text: "OL-ST: Standard" },
  { 
    row: 18,
    column: 4,
    text: "A Standard Overlay defines a documented agreement or technical specification published by a standards organisation used to represent, format, define, structure, tag, transmit, manipulate, use, and manage data." 
  },
  { row: 19, column: 2, text: "Information Overlay" },
  { row: 19, column: 3, text: "OL-IN: Information" },
  {
    row: 19,
    column: 4,
  ...
  { row: 20, column: 2, text: "Data Type" },
  { row: 20, column: 4, text: "The data types are as follows:" },
  { row: 21, column: 3, text: "Text" },
  {
    row: 21,
    column: 4,
  ...
  { row: 23, column: 3, text: "Reference" },
  {
    row: 23,
    column: 4,
  ...
  { row: 27, column: 3, text: "Array[data type]" },
  {
    row: 27,
    column: 4,
  ...
  { row: 33, column: 2, text: "OL = Overlay" },
  { row: 34, column: 2, text: "SAI = Self-Addressing Identifier" },
  { row: 35, column: 2, text: "URL = Uniform Resource Locator" },
  { row: 36, column: 2, text: "PII = Personally Identifiable Information" },
  { row: 37, column: 2, text: "QII = Quasi-identifiable information" },
  {
    row: 38,
    column: 2,
  ...
  { row: 40, column: 2, text: "FOR = Field of Research" },
];
