...
test("match Regex (Entries of any length with only capital letters)", () => {
  const pattern =
    descriptionToFormatCodeText["Entries of any length with only capital letters"];
  const testTexts = [
    "ABC",
    "ABCDEFF",
    "A",
  ...
  const badTestTexts = ["abc123", "abc", "123", "abcABC", "Aaa"];
...
test("match Regex (Capital or lower case letters only, at least 1 character, and 50 characters max)", () => {
  ...
  const testTexts = ["ABC", "abc", "ABCDEFF", "A"];
...
test("match Regex (Capital or lower case letters only, 50 characters max)", () => {
  const pattern =
    descriptionToFormatCodeText["Capital or lower case letters only, 50 characters max"];
  const testTexts = ["", "ABC", "abc", "ABCDEFF", "A"];
...
test("match Regex (Short text, 50 characters max)", () => {
  ...
  const testTexts = ["", "ABC", "abc", "ABCDEFF", "A", "abc123", "123"];
...
test("match Regex (Canadian postal codes (A1A 1A1))", () => {
  ...
  const testTexts = ["A1A 1A1", "N2L 3G1", "J8T 1A1", "K1A 1A1"];

  const badTestTexts = ["AA2A1A", "A1A1A", "A1A 1A", "A12 1A1", "N2L3G1"];
...
test("match Regex (Email address)", () => {
  ...
  const badTestEmails = ["example1@something", "example1@something."];
